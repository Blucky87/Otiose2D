...
namespace Nez.Spriter
{
    ...
    /// </summary>
	public class SpriterAnimator : Animator<Sprite, SoundEffect>
    {
        /// <summary>
        ...
        private static readonly float SpriteAtlasRotation = -90 * Mathf.DegToRad;
        private static readonly float DefaultDepth = 0.5f;
        private static readonly float DefaultDeltaDepth = -0.000001f;

        public SpriterAnimator(SpriterEntity entity, IProviderFactory<Sprite, SoundEffect> providerFactory = null) : base(entity, providerFactory)
        {
