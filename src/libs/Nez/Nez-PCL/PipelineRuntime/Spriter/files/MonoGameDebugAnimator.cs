...
namespace Nez.SpriterAnimator
{
  public class MonoGameDebugAnimator : MonoGameAnimator
  {
    ...
    public MonoGameDebugAnimator(SpriterEntity entity, GraphicsDevice graphicsDevice,
      IProviderFactory<Sprite, SoundEffect> providerFactory = null) : base(entity, providerFactory)
    {
