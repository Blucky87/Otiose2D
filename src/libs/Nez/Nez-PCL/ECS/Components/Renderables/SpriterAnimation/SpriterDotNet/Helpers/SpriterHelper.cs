...
namespace Nez.Spriter.Helpers
{
    internal static class SpriterHelper
    {
        ...
        public static void Interpolate(this SpriterVarValue target, SpriterVarValue valA, SpriterVarValue valB, float factor)
        {
            ...
            target.FloatValue = Mathf.Linear(valA.FloatValue, valB.FloatValue, factor);
            target.IntValue = (int)Mathf.Linear(valA.IntValue, valB.IntValue, factor);
        }
        ...
        {
            target.Angle = Mathf.AngleLinear(a.Angle, b.Angle, spin, factor);
            target.X = Mathf.Linear(a.X, b.X, factor);
            target.Y = Mathf.Linear(a.Y, b.Y, factor);
            target.ScaleX = Mathf.Linear(a.ScaleX, b.ScaleX, factor);
            target.ScaleY = Mathf.Linear(a.ScaleY, b.ScaleY, factor);
        }
        ...
        {
            target.Angle = Mathf.AngleLinear(a.Angle, b.Angle, spin, factor);
            target.Alpha = Mathf.Linear(a.Alpha, b.Alpha, factor);
            target.X = Mathf.Linear(a.X, b.X, factor);
            target.Y = Mathf.Linear(a.Y, b.Y, factor);
            target.ScaleX = Mathf.Linear(a.ScaleX, b.ScaleX, factor);
            target.ScaleY = Mathf.Linear(a.ScaleY, b.ScaleY, factor);
            ...
            target.T = Mathf.Linear(a.T, b.T, factor);
        }
        ...
        public static float AdjustFactor(float factor, SpriterKey key)
        {
            switch (key.CurveType)
            {
                ...
                case SpriterCurveType.Quadratic:
                    factor = Mathf.Bezier(0.0f, key.C1, 1.0f, factor);
                    break;
                case SpriterCurveType.Cubic:
                    factor = Mathf.Bezier(0.0f, key.C1, key.C2, 1.0f, factor);
                    break;
                case SpriterCurveType.Quartic:
                    factor = Mathf.Bezier(0.0f, key.C1, key.C2, key.C3, 1.0f, factor);
                    break;
                case SpriterCurveType.Quintic:
                    factor = Mathf.Bezier(0.0f, key.C1, key.C2, key.C3, key.C4, 1.0f, factor);
                    break;
                case SpriterCurveType.Bezier:
                    factor = Mathf.Bezier2D(key.C1, key.C2, key.C3, key.C4, factor);
                    break;
            }
        ...
        public static float AdjustTime(float targetTime, SpriterKey keyA, SpriterKey keyB, float animationLength)
        {
            ...
            return Mathf.Linear(keyA.Time, nextTime, factor);
        }
        ...
        public static float GetFactor(SpriterKey keyA, SpriterKey keyB, float animationLength, float targetTime)
        {
            ...
            float factor = Mathf.GetFactor(timeA, timeB, targetTime);
